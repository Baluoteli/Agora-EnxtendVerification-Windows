...
LRESULT COpenLiveDlg::OnJoinChannel(WPARAM wParam, LPARAM lParam)
{
	...
	lpAgoraObject->EnableExtendAudioCapture(TRUE, &m_extendAudio);
	lpAgoraObject->EnableExtendVideoCapture(TRUE, &m_extendVideo);
	lpAgoraObject->SetAudioProfileEx(44100, 2, 44100 * 2 / 100);
